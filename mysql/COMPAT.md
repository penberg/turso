...
| Other date/time functions (`STR_TO_DATE`, `MAKETIME`, `CONVERT_TZ`, …) | ❌ | **Excluded** — format/type or timezone differences. (`DATEDIFF`/`TIMESTAMPDIFF` *are* supported; see their own tests.) |
